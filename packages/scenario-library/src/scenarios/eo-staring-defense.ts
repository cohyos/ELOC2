...
export const eoStaringDefense: ScenarioDefinition = {
  ...
  targets: [
    ...
    // Phase 2: Shahed-136 formation (5 drones) — 3km spacing for dual-sensor discrimination
    // ~3 km spacing — above radar merge threshold (500m) so both EO and radar
    // can detect, track, and discriminate each formation member independently.
    // EO staring sensors can resolve much tighter formations (~200m), but 3km
    // ensures clean tracking in both sensor modes.
    {
      targetId: 'TGT-S136-1',
